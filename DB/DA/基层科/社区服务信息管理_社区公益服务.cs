...
namespace DB.DA.基层科
{
    class 社区服务信息管理_社区公益服务
    {
        ...
        public DataTable GetWhere(string strWhere)
        {
            ...
            string strSql = String.Format("select * from {0} {1} order by ID desc", DB.Tab.基层科.社区服务信息管理_社区公益服务.TAB, strWhere);
		...
		public DataTable GetPage( int nPageNo , string strWhere )
        {
            ...
            DataTable dt = new DataTable ();
            string strSql = SQL.GetPageSql2005 ( DB.Tab.基层科.社区服务信息管理_社区公益服务.TAB, nPageNo, CONST.PageSize, DB.Tab.基层科.社区服务信息管理_社区公益服务.ID, strWhere, false );
			dt = Sql.ExecDataTable ( strSql );
		...
		public int GetPageMax(string strWhere)
        {
            ...
            int nPageNum = Sql.GetPageMaxPage(DB.Tab.基层科.社区服务信息管理_社区公益服务.TAB, strWhere, ref nRecCount, CONST.PageSize);
		...
		public void Update_ByID( string strID, string strFld, string strVal )
        {
            ...
            string strSql = String.Format (  "update {0} set {1}='{2}' where ID='{3}'", DB.Tab.基层科.社区服务信息管理_社区公益服务.TAB, strFld, strVal, strID  );
            Sql.Exec ( strSql );
		...
		public DataTable GetSum (string strFld, string strWhere )
        {
            ...
            string strSql = String.Format("select Sum({2}) from {0} {1} ", DB.Tab.基层科.社区服务信息管理_社区公益服务.TAB, strWhere, strFld );
            dt = Sql.ExecDataTable(strSql);
