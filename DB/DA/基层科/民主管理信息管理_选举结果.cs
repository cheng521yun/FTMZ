...
namespace DB.DA.基层科
{
    class 民主管理信息管理_选举结果
    {
        ...
        public DataTable GetWhere(string strWhere)
        {
            ...
            string strSql = String.Format("select * from {0} {1} order by ID desc", DB.Tab.基层科.民主管理信息管理_选举结果.TAB, strWhere);
		...
		public int GetPageMax(string strWhere)
        {
            ...
            int nPageNum = Sql.GetPageMaxPage(DB.Tab.基层科.民主管理信息管理_选举结果.TAB, strWhere, ref nRecCount, CONST.PageSize);
		...
		public DataTable GetCount ( string strWhere )
        {
            ...
            string strSql = String.Format("select Count(*) from {0} {1} ", DB.Tab.基层科.民主管理信息管理_选举结果.TAB, strWhere);
            dt = Sql.ExecDataTable(strSql);
