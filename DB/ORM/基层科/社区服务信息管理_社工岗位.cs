...
namespace DB.Orm.基层科
{
    ...
    {
        DB.DA.基层科.社区服务信息管理_社工岗位 da = new DB.DA.基层科.社区服务信息管理_社工岗位();
		...
		public List<DB.Stru.基层科.社区服务信息管理_社工岗位> Get_ByWhere (string strWhere)
		{
			...
			lst = DB.Stru.基层科.社区服务信息管理_社工岗位.Dt2List(ref dt);
	
			return lst;
		}
		
		public DB.Stru.基层科.社区服务信息管理_社工岗位 GetFirst_ByWhere (string strWhere)
		{
			DB.Stru.基层科.社区服务信息管理_社工岗位 stru = new DB.Stru.基层科.社区服务信息管理_社工岗位 () ;
			List<DB.Stru.基层科.社区服务信息管理_社工岗位> list = Get_ByWhere ( strWhere ) ;
		...
		public DB.Stru.基层科.社区服务信息管理_社工岗位 Get_ByID (string strID)
		{
		...
		public List<DB.Stru.基层科.社区服务信息管理_社工岗位> GetPage( int nPageNo , string strWhere )
        {
            List<DB.Stru.基层科.社区服务信息管理_社工岗位> lst = new List<DB.Stru.基层科.社区服务信息管理_社工岗位> ();
        ...
        public string Save( DB.Stru.基层科.社区服务信息管理_社工岗位 stru )
        {
		...
		public bool Save ( List<DB.Stru.基层科.社区服务信息管理_社工岗位> lst )
        {
            bool bRet = true;
            string strID;
            foreach ( DB.Stru.基层科.社区服务信息管理_社工岗位 stru in lst )
            {
                strID = Save ( stru );
		...
		public void Delete( DB.Stru.基层科.社区服务信息管理_社工岗位 stru )
        {
		...
		public void Delete( List<DB.Stru.基层科.社区服务信息管理_社工岗位> lst )
        {
			foreach ( DB.Stru.基层科.社区服务信息管理_社工岗位 stru in lst )
            	da.Delete_ByID ( stru.ID );
        }
