...
namespace DB.Orm.基层科
{
    public class 社区服务信息管理_社区公益服务
    {
        DB.DA.基层科.社区服务信息管理_社区公益服务 da = new DB.DA.基层科.社区服务信息管理_社区公益服务();
		...
		public List<DB.Stru.基层科.社区服务信息管理_社区公益服务> Get_ByWhere (string strWhere)
		{
			...
			lst = DB.Stru.基层科.社区服务信息管理_社区公益服务.Dt2List(ref dt);
	
			return lst;
		}
		
		public DB.Stru.基层科.社区服务信息管理_社区公益服务 GetFirst_ByWhere (string strWhere)
		{
			DB.Stru.基层科.社区服务信息管理_社区公益服务 stru = new DB.Stru.基层科.社区服务信息管理_社区公益服务 () ;
			List<DB.Stru.基层科.社区服务信息管理_社区公益服务> list = Get_ByWhere ( strWhere ) ;
		...
		public DB.Stru.基层科.社区服务信息管理_社区公益服务 Get_ByID (string strID)
		{
		    string strWhere = String.Format("{0}='{1}'", DB.Tab.基层科.社区服务信息管理_社区公益服务.ID, strID);
		...
		public List<DB.Stru.基层科.社区服务信息管理_社区公益服务> GetPage( int nPageNo , string strWhere )
        {
            List<DB.Stru.基层科.社区服务信息管理_社区公益服务> lst = new List<DB.Stru.基层科.社区服务信息管理_社区公益服务> ();
        ...
        public string Save( DB.Stru.基层科.社区服务信息管理_社区公益服务 stru )
        {
		...
		public bool Save ( List<DB.Stru.基层科.社区服务信息管理_社区公益服务> lst )
        {
            bool bRet = true;
            string strID;
            foreach ( DB.Stru.基层科.社区服务信息管理_社区公益服务 stru in lst )
            {
                strID = Save ( stru );
		...
		public void Delete( DB.Stru.基层科.社区服务信息管理_社区公益服务 stru )
        {
		...
		public void Delete( List<DB.Stru.基层科.社区服务信息管理_社区公益服务> lst )
        {
			foreach ( DB.Stru.基层科.社区服务信息管理_社区公益服务 stru in lst )
            	da.Delete_ByID ( stru.ID );
        }
