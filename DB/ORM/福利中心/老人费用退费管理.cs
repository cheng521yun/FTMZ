...
namespace DB.Orm.福利中心
{
    ...
    {
        DB.DA.福利中心.老人费用退费管理 da = new DB.DA.福利中心.老人费用退费管理();
		...
		public List<DB.Stru.福利中心.老人费用退费管理> Get_ByWhere (string strWhere)
		{
			...
			lst = DB.Stru.福利中心.老人费用退费管理.Dt2List(ref dt);
	
			return lst;
		}
		
		public DB.Stru.福利中心.老人费用退费管理 GetFirst_ByWhere (string strWhere)
		{
			DB.Stru.福利中心.老人费用退费管理 stru = new DB.Stru.福利中心.老人费用退费管理 () ;
			List<DB.Stru.福利中心.老人费用退费管理> list = Get_ByWhere ( strWhere ) ;
		...
		public DB.Stru.福利中心.老人费用退费管理 Get_ByID (string strID)
		{
		...
		public List<DB.Stru.福利中心.老人费用退费管理> GetPage( int nPageNo , string strWhere )
        {
            List<DB.Stru.福利中心.老人费用退费管理> lst = new List<DB.Stru.福利中心.老人费用退费管理> ();
        ...
        public string Save( DB.Stru.福利中心.老人费用退费管理 stru )
        {
		...
		public bool Save ( List<DB.Stru.福利中心.老人费用退费管理> lst )
        {
            bool bRet = true;
            string strID;
            foreach ( DB.Stru.福利中心.老人费用退费管理 stru in lst )
            {
                strID = Save ( stru );
		...
		public void Delete( DB.Stru.福利中心.老人费用退费管理 stru )
        {
		...
		public void Delete( List<DB.Stru.福利中心.老人费用退费管理> lst )
        {
			foreach ( DB.Stru.福利中心.老人费用退费管理 stru in lst )
            	da.Delete_ByID ( stru.ID );
        }
