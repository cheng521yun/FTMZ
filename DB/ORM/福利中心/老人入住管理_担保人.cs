...
namespace DB.Orm.福利中心
{
    ...
    {
        DB.DA.福利中心.老人入住管理_担保人 da = new DB.DA.福利中心.老人入住管理_担保人();
		...
		public List<DB.Stru.福利中心.老人入住管理_担保人> Get_ByWhere (string strWhere)
		{
			...
			lst = DB.Stru.福利中心.老人入住管理_担保人.Dt2List(ref dt);
	
			return lst;
		}
		
		public DB.Stru.福利中心.老人入住管理_担保人 GetFirst_ByWhere (string strWhere)
		{
			DB.Stru.福利中心.老人入住管理_担保人 stru = new DB.Stru.福利中心.老人入住管理_担保人 () ;
			List<DB.Stru.福利中心.老人入住管理_担保人> list = Get_ByWhere ( strWhere ) ;
		...
		public DB.Stru.福利中心.老人入住管理_担保人 Get_ByID (string strID)
		{
        ...
        public string Save( DB.Stru.福利中心.老人入住管理_担保人 stru )
        {
		...
		public bool Save ( List<DB.Stru.福利中心.老人入住管理_担保人> lst )
        {
            bool bRet = true;
            string strID;
            foreach ( DB.Stru.福利中心.老人入住管理_担保人 stru in lst )
            {
                strID = Save ( stru );
		...
		public void Delete( DB.Stru.福利中心.老人入住管理_担保人 stru )
        {
		...
		public void Delete( List<DB.Stru.福利中心.老人入住管理_担保人> lst )
        {
			foreach ( DB.Stru.福利中心.老人入住管理_担保人 stru in lst )
            	da.Delete_ByID ( stru.ID );
        }
