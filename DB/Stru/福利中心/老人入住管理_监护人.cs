...
namespace DB.Stru.福利中心
{
    public class 老人入住管理_监护人
    {
		...
		public bool Dr2Stru(DataRow dr)
		{
			...
			ID = dr[DB.Tab.福利中心.老人入住管理_监护人.ID].ToString().Trim();
			父ID = dr[DB.Tab.福利中心.老人入住管理_监护人.父ID].ToString().Trim();
			CreateDate = dr[DB.Tab.福利中心.老人入住管理_监护人.CreateDate].ToString().Trim();
			Creator = dr[DB.Tab.福利中心.老人入住管理_监护人.Creator].ToString().Trim();
			姓名 = dr[DB.Tab.福利中心.老人入住管理_监护人.姓名].ToString().Trim();
			关系 = dr[DB.Tab.福利中心.老人入住管理_监护人.关系].ToString().Trim();
			地址或工作单位 = dr[DB.Tab.福利中心.老人入住管理_监护人.地址或工作单位].ToString().Trim();
			联系电话 = dr[DB.Tab.福利中心.老人入住管理_监护人.联系电话].ToString().Trim();
		...
		public static DataTable List2Dt ( ref List<DB.Stru.福利中心.老人入住管理_监护人> lst )
        {
            DB.Orm.福利中心.老人入住管理_监护人 orm = new DB.Orm.福利中心.老人入住管理_监护人 ();
            DataTable dt = orm.GetBlank();

            foreach ( DB.Stru.福利中心.老人入住管理_监护人 o in lst )
            {
        ...
        public static DB.Stru.福利中心.老人入住管理_监护人 StruFromList_ByID ( ref List<DB.Stru.福利中心.老人入住管理_监护人> list, string strID )
        {
		    if ( strID.Trim() == String.Empty )
                return null;
				
            foreach ( DB.Stru.福利中心.老人入住管理_监护人 stru in list )
            {
                if( stru.ID == strID )
                    return stru;
            }
		...
		public void Stru2Dr( ref DataRow dr)
        {
			...
			dr[DB.Tab.福利中心.老人入住管理_监护人.姓名] = 姓名;
			dr[DB.Tab.福利中心.老人入住管理_监护人.关系] = 关系;
			dr[DB.Tab.福利中心.老人入住管理_监护人.地址或工作单位] = 地址或工作单位;
			dr[DB.Tab.福利中心.老人入住管理_监护人.联系电话] = 联系电话;
        }
		
		public void CopyFrom( DB.Stru.福利中心.老人入住管理_监护人 struFrom )
        {
			ID = struFrom.ID;
			父ID = struFrom.父ID;
        ...
        /// </summary>
        /// <returns></returns>
		public string GetLogStr ( DB.Stru.福利中心.老人入住管理_监护人 struOrg )
        {
