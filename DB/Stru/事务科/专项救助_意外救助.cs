...
namespace DB.Stru.事务科
{
    public class 专项救助_意外救助
    {
        ...
        public bool Dr2Stru( DataRow dr )
        {
            ...
            ID = dr[ DB.Tab.事务科.专项救助_意外救助.ID ].ToString().Trim();
            所属街道 = dr[ DB.Tab.事务科.专项救助_意外救助.所属街道 ].ToString().Trim();
            姓名 = dr[ DB.Tab.事务科.专项救助_意外救助.姓名 ].ToString().Trim();
            性别 = dr[ DB.Tab.事务科.专项救助_意外救助.性别 ].ToString().Trim();
            联系电话 = dr[ DB.Tab.事务科.专项救助_意外救助.联系电话 ].ToString().Trim();
            救助原因 = dr[ DB.Tab.事务科.专项救助_意外救助.救助原因 ].ToString().Trim();
            金额 = dr[ DB.Tab.事务科.专项救助_意外救助.金额 ].ToString().Trim();
            救助时间 = dr[ DB.Tab.事务科.专项救助_意外救助.救助时间 ].ToString().Trim();
            类别 = dr[ DB.Tab.事务科.专项救助_意外救助.类别 ].ToString().Trim();
            备注 = dr[ DB.Tab.事务科.专项救助_意外救助.备注 ].ToString().Trim();

            return true;
        }

        public static List<DB.Stru.事务科.专项救助_意外救助> Dt2List( ref DataTable dt )
        {
            List<DB.Stru.事务科.专项救助_意外救助> lst = new List<DB.Stru.事务科.专项救助_意外救助>();
            ...
            {
                DB.Stru.事务科.专项救助_意外救助 stru = new DB.Stru.事务科.专项救助_意外救助();
                stru.Dr2Stru( dr );
                lst.Add( stru );
            }
        ...
        public static DataTable List2Dt( ref List<DB.Stru.事务科.专项救助_意外救助> lst )
        {
            DB.Orm.事务科.专项救助_意外救助 orm = new DB.Orm.事务科.专项救助_意外救助();
            DataTable dt = orm.GetBlank();

            foreach ( DB.Stru.事务科.专项救助_意外救助 o in lst )
            {
        ...
        public static DB.Stru.事务科.专项救助_意外救助 StruFromList_ByID( ref List<DB.Stru.事务科.专项救助_意外救助> list, string strID )
        {
            if ( strID.Trim() == String.Empty )
                return null;

            foreach ( DB.Stru.事务科.专项救助_意外救助 stru in list )
            {
                if ( stru.ID == strID )
                    return stru;
            }
        ...
        public void Stru2Dr( ref DataRow dr )
        {
            if ( ID.Trim() != String.Empty )
                dr[ DB.Tab.事务科.专项救助_意外救助.ID ] = ID;

            CheckData();

            dr[ DB.Tab.事务科.专项救助_意外救助.所属街道 ] = 所属街道;
            dr[ DB.Tab.事务科.专项救助_意外救助.姓名 ] = 姓名;
            dr[ DB.Tab.事务科.专项救助_意外救助.性别 ] = 性别;
            dr[ DB.Tab.事务科.专项救助_意外救助.联系电话 ] = 联系电话;
            dr[ DB.Tab.事务科.专项救助_意外救助.救助原因 ] = 救助原因;
            dr[ DB.Tab.事务科.专项救助_意外救助.金额 ] = 金额;
            if ( 救助时间 != String.Empty )
                dr[ DB.Tab.事务科.专项救助_意外救助.救助时间 ] = 救助时间;
            dr[ DB.Tab.事务科.专项救助_意外救助.类别 ] = 类别;
            dr[ DB.Tab.事务科.专项救助_意外救助.备注 ] = 备注;
        }

        public void CopyFrom( DB.Stru.事务科.专项救助_意外救助 struFrom )
        {
            ID = struFrom.ID;
            所属街道 = struFrom.所属街道;
            姓名 = struFrom.姓名;
        ...
        /// </summary>
        /// <returns></returns>
        public string GetLogStr( DB.Stru.事务科.专项救助_意外救助 struOrg )
        {
