...
using 福田民政.Forms.Work.数据管理.福利中心.老人入住.Tab.监护人;   
namespace 福田民政.Forms.数据管理.福利中心.老人入住.Tab
{
    public partial class 监护人 : XForm
    {
        List<DB.Stru.福利中心.老人入住管理_监护人> _lst = new List<DB.Stru.福利中心.老人入住管理_监护人>();
        ...
        public void Find(string strWhere)
        {
            ...
            //设置翻页的数码。
            fl.MaxPage = BL.福利中心.老人入住管理_监护人.GetPageMax(strWhere);
            ShowPage(0);
        }

        void ShowPage(int nPageNo)
        {
            _lst = BL.福利中心.老人入住管理_监护人.GetPage(nPageNo, _strWhere); ;
        ...
        void Modify(int nRow, int nCol)
        {
            ...
            DB.Stru.福利中心.老人入住管理_监护人 struSel = fl.grd.Rows[nRow].DataBoundItem as DB.Stru.福利中心.老人入住管理_监护人;
            if (struSel == null)
                return;
